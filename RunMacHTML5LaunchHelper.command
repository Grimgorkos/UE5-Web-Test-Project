...
EPIC_MONO=""
if [ -f "F:\Programs\UE_4.23\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "F:\Programs\UE_4.23\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'F:\Programs\UE_4.23\Engine\Build\BatchFiles\Mac\SetupMono.sh';
fi
